...
public class RestaurantController {
	...
	public String list(@RequestParam(name="start",required=false, defaultValue="0") int start, ModelMap model) {
		...
		//chicken
		List<Chicken> chicken_ranking = chickenService.getTop10Chicken(start);
		...
		//cafe
		List<Cafe> cafe_ranking = cafeService.getTop10Cafe(start);
		...
		//dduck
		List<DDuck> dduck_ranking = dduckService.getTop10DDuck(start);
